...
const (
	TripService_CreateTrip_FullMethodName = "/proto.TripService/CreateTrip"
)
...
type TripServiceClient interface {
	CreateTrip(ctx context.Context, in *NewTrip, opts ...grpc.CallOption) (*Trip, error)
}
...
func (c *tripServiceClient) CreateTrip(ctx context.Context, in *NewTrip, opts ...grpc.CallOption) (*Trip, error) {
	out := new(Trip)
...
type TripServiceServer interface {
	CreateTrip(context.Context, *NewTrip) (*Trip, error)
...
func (UnimplementedTripServiceServer) CreateTrip(context.Context, *NewTrip) (*Trip, error) {
...
func _TripService_CreateTrip_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TripServiceServer).CreateTrip(ctx, req.(*NewTrip))
	}
